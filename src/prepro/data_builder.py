...
#             print('REAL NAME: ', json_f, real_name)
            a_lst.append(
                (
                    corpus_type,
                    json_f,
...
def _format_to_bert(params):
    ...
    print("_fomat_to_bert params.save_file : ", save_file)
...
def format_df_to_bert(cfg):
    ...
    def _format_df_to_bert(df, subdata_group):
        ...
        os.system(
            f"python {os.path.join(os.path.abspath(os.path.dirname(os.path.dirname(__file__))), 'preprocess.py')}"
