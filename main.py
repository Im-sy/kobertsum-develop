...
PROBLEM = 'ext'
## 사용할 path 정의
PROJECT_DIR = 'C:/Users/isy51/OneDrive/Desktop/github/KoBertSum-develop'
# PROJECT_DIR = os.getcwd()
print(PROJECT_DIR)

# DATA_DIR = f'{PROJECT_DIR}/{PROBLEM}/data'
DATA_DIR = f'{PROJECT_DIR}/datasets/bflysoft_ko'
RAW_DATA_DIR = DATA_DIR + '/df'
...
#     now = "0627_1700"
    ...
    # python main.py -mode train -target_summary_sent abs -visible_gpus 0 -train_from 1209_1236/model_step_7000.pt 
        ...
        do_str = f"python train.py -task abs -mode train"  \
        ...
        param3 = " -ext_dropout 0.1 -max_pos 256 -lr 2e-3 -warmup_steps 10000 -batch_size 256 -accum_count 2 -train_steps 50000 -use_interval true"  
        do_str += param3
  
        if args.train_from is None:
            os.mkdir(f'{MODEL_DIR}/{now}')
    ...
    # python main.py -mode valid -model_path 1209_1236
        ...
        """
        os.system(f"python train.py -task abs -mode validate"
            ...
            + f" -test_batch_size 256  -batch_size 256"
            + f" -sep_optim true -use_interval true -visible_gpus {args.visible_gpus}"
            + f" -max_pos 256 -max_length 200 -alpha 0.95 -min_length 50"
    ...
    # python main.py -mode test -test_from 1209_1236/model_step_7000.pt -visible_gpus 0
        ...
        os.system(f"""\
            ...
            -test_batch_size 1  -batch_size 256 \
            -sep_optim true -use_interval true -visible_gpus {args.visible_gpus} \
            -max_pos 256 -max_length 200 -alpha 0.95 -min_length 50 \
            -report_rouge False \
            -max_tgt_len 128
        """)
        # -max_pos 512 -max_length 200 -alpha 0.95 -min_length 50 \
        ...
        os.system(f"python ../make_submission_bflysoft_ko.py result_{model_folder}_{model_name}.candidate")
